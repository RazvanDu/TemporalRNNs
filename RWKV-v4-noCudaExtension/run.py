...
if TOKEN_MODE == 'char':
    MODEL_NAME = 'trained-smallEmbed-624.pth'  # your trained model
...
os.environ['RWKV_FLOAT_MODE'] = 'tf32'  # 'bf16' / 'fp16' / 'fp32' (note: only using fp32 at this moment)
